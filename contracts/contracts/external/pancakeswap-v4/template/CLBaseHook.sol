...
} from "../core/pool-cl/interfaces/ICLHooks.sol"; 
import {PoolKey} from "../core/types/PoolKey.sol"; 
import {BalanceDelta} from "../core/types/BalanceDelta.sol";
import {BeforeSwapDelta} from "../core/types/BeforeSwapDelta.sol";
import {IHooks} from "../core/interfaces/IHooks.sol";
import {IVault} from "../core/interfaces/IVault.sol";
import {ICLHooks} from "../core/pool-cl/interfaces/ICLHooks.sol";
import {ICLPoolManager} from "../core/pool-cl/interfaces/ICLPoolManager.sol";
import {IProtocolFees} from "../core/interfaces/IProtocolFees.sol";
...
abstract contract CLBaseHook is ICLHooks {
    ...
    constructor(ICLPoolManager _poolManager) {
        ...
        vault = IProtocolFees(address(poolManager)).vault();
    }
